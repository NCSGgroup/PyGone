...
class GeoMathKit:
    ...
    def monthListByMonth(begin, end):
        """
        get the date of every month between the given 'begin' month and 'end' month
    ...
    @staticmethod
    def ReadEndOfHeader(file_name, end_flag):
        """
        return the number of 'end of header'
        :param file_name:
        :param end_flag:
        :return:
        """
    ...
    @staticmethod
    def as2rad(arcsrc):
        return arcsrc *np.pi/180/3600

    @staticmethod
    def rad2as(rad):
        return 180/np.pi*3600*rad


if __name__ == '__main__':
    # CS = np.array([23, 56, 78, 90, 32, 34])
    # GeoMathKit.CS_1dTo2d(CS)
    # res = GeoMathKit.getPnm(lat=26.3001211866273, Nmax=3, option=5)
    GeoMathKit.un_tar('../data/GRACE_FO/RL04/L1A/2021-01/gracefo_1A_2021-01-03_RL04.ascii.noLRI.tgz')
    pass
