...
class TideFit:
    ...
    def fit(self):
        ...
        #         for time in self._timeEpoch:
        #
        #             ld.setTime_for_tide_Bai(date=date.strftime("%Y-%m-%d"), time=time)
    ...
    def generateTide_bySphere(self,end:str, tides: dict, Nmax: int, lat, lon):
        ...
        LN = LoveNumber('I:/CRALICOM/data/Auxiliary/')
...
def demo2():
    ...
    tf.setDataDir(dataDirIn='I:\CRALICOM\data\CRA40/', dataDirOut='I:\PyCode\DeAliasing/result/')
    tf.setDuration(begin='2007-01-01', end='2007-12-31')
    tf.fit()
    ...
    tf.generateTide_bySphere(end='2007',tides=tides, Nmax=100, lat=lat, lon=lon)
