...
from src.AOD.CRA_LICOM.Configure.Harmonic import Harmonic
from src.AOD.CRA_LICOM.Configure.LoadSH import LoadSH, Gif48
from src.AOD.CRA_LICOM.Configure.LoveNumber import LoveNumber
from src.AOD.CRA_LICOM.Configure.RefEllipsoid import EllipsoidType, RefEllipsoid
from src.AOD.CRA_LICOM.Configure.Setting import SynthesisType, LoveNumberType
...
class GeoidUndulation:
    ...
    __LN = LoveNumber('../../data/Auxiliary/')
    ...
    def __default(self):
        ...
        """
        self.__Nmax = 160
        self.__SH = Gif48().load('../../data/Auxiliary/GIF48.gfc')
