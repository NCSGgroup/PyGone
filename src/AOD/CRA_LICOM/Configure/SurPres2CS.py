...
from src.AOD.CRA_LICOM.Configure.Harmonic import Harmonic, Harmonic2
...
from src.AOD.CRA_LICOM.Configure.Setting import EllipsoidType, LoveNumberType, DataType, Constants, HarAnalysisType
