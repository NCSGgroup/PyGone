...
from src.AOD.CRA_LICOM.Configure.Harmonic import Harmonic, SynthesisType, HarAnalysisType
from src.AOD.CRA_LICOM.Configure.LoadSH import SimpleSH
from src.AOD.CRA_LICOM.Configure.LoveNumber import LoveNumberType, LoveNumber
import xarray as xr
...
class LandSeaMask:
    ...
    def __method3(self):
        ...
        """
        # lmax = 360
        # SHC, SHS = SimpleSH().load('../../data/Auxiliary/ocean360_grndline.sh').getCS(lmax)
        #
        # LN = LoveNumber('../../data/Auxiliary/')
        ...
        #
        mask = xr.open_dataset('../Auxiliary/mask_720X361.nc')
        ocean_mask = mask['mask'].values
        land_mask = 1-ocean_mask
        # print(land_mask)

        self.__ocean = land_mask > 0.5
